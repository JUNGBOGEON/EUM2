...
import { FolderOpen, ArrowLeft, Construction } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto p-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">회의록 보관함</h1>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center border border-dashed border-border rounded-xl">
          ...
          <p className="text-muted-foreground max-w-sm">
            회의록 보관함 기능은 곧 제공될 예정입니다.
            모든 회의록을 한곳에서 검색하고 관리할 수 있습니다.
          </p>
        </div>
      </div>
    </div>
