...
1. 어조: 비즈니스적이고, 객관적이며, '해요체' 또는 '하십시오체'를 사용하세요.
   - **중요**: 모든 문장에서 반드시 존댓말을 사용하세요. 반말("~함", "~했음", "~하기로 함")은 절대 사용하지 마세요.
   - 참가자 이름에는 반드시 "님"을 붙이세요. (예: "정보건님", "김철수님")
   - 올바른 예시:
     * "정보건님이 데이터베이스를 추가하기로 하셨습니다" (O)
     * "김철수님이 다음 주까지 완료할 예정입니다" (O)
   - 잘못된 예시:
     * "정보건이 추가하기로 함" (X - 반말, 님 누락)
     * "김철수가 완료 예정" (X - 반말, 님 누락)
...
| 담당자 | 할 일 | 마감기한(언급 시) |
| :--- | :--- | :--- |
| (이름)님 | (구체적인 작업 내용을 존댓말로 작성) | (YYYY-MM-DD 또는 '미정') |
...
[출력 형식 - 반드시 유효한 JSON으로 출력]
{
  "sections": [
    ...
    },
    {
      "id": "agenda-1",
      "type": "agenda",
      "content": "## 2. 논의 안건 상세\\n\\n### 2.1 [첫 번째 안건명]\\n\\n**배경:** 이 안건이 논의된 이유나 맥락을 설명합니다.\\n\\n**주요 의견:**\\n- **[발언자A]님**: 의견 내용을 상세히 기록 (존댓말 사용)\\n- **[발언자B]님**: 다른 관점이나 보완 의견\\n- **[발언자C]님**: 추가 제안이나 우려사항\\n\\n**논의 결과:** 합의된 내용 또는 추가 논의 필요 여부 (존댓말로 작성)\\n\\n---\\n\\n### 2.2 [두 번째 안건명]\\n\\n**배경:** ...\\n\\n**주요 의견:**\\n- **[발언자]님**: ...\\n\\n**논의 결과:** ...",
      "transcriptRefs": ["관련발화ID들"]
    },
    {
      "id": "decision-1",
      "type": "decision",
      "content": "## 3. 결정 사항\\n\\n### ✅ 확정된 결정\\n\\n| 결정 내용 | 결정 배경/근거 | 결정자 |\\n| :--- | :--- | :--- |\\n| [결정1 내용 - 존댓말로 작성] | [왜 이렇게 결정했는지] | [결정자]님 |\\n| [결정2 내용 - 존댓말로 작성] | [배경 설명] | [결정자]님 |\\n\\n### ⏸️ 보류/추가 검토 필요\\n\\n- [보류된 사항]: 보류 사유 및 재논의 예정일 (존댓말로 작성)",
      "transcriptRefs": ["관련발화ID들"]
    },
    {
      "id": "action-1",
      "type": "action_item",
      "content": "## 4. 액션 아이템\\n\\n| 우선순위 | 담당자 | 할 일 | 마감기한 | 관련 논의 |\\n| :---: | :--- | :--- | :--- | :--- |\\n| 🔴 높음 | [이름]님 | [구체적인 작업 내용을 존댓말로 작성] | YYYY-MM-DD | [어떤 논의에서 나온 건지] |\\n| 🟡 중간 | [이름]님 | [작업 내용을 존댓말로 작성] | YYYY-MM-DD | [관련 맥락] |\\n| 🟢 낮음 | [이름]님 | [작업 내용을 존댓말로 작성] | 미정 | [관련 맥락] |\\n\\n**총 액션 아이템:** N개 (높음: n개, 중간: n개, 낮음: n개)",
      "transcriptRefs": ["관련발화ID들"]
    },
    {
      "id": "unresolved-1",
      "type": "note",
      "content": "## 5. 미해결 이슈 및 후속 논의\\n\\n### 🔄 추가 논의 필요\\n\\n- **[이슈1]**: 미해결 사유, 다음 회의에서 논의할 예정입니다\\n- **[이슈2]**: 추가 정보가 필요하며, [담당자]님이 조사 후 공유해 주실 예정입니다\\n\\n### ❓ 열린 질문\\n\\n- [회의 중 답변되지 않은 질문들 - 존댓말로 작성]",
      "transcriptRefs": ["관련발화ID들"]
    },
    {
      "id": "data-1",
